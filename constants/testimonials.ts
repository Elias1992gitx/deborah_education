export const testimonials = [
  {
    name: 'Yohannes Libanos',
    designation: 'CEO at NexusLabs',
    image:
    ...
    quote:
      "Tekletsadik's contributions to the Nexus Deep project were invaluable. His technical skills and innovative approach significantly improved our platform.",
  },
  {
    name: 'Dr. Abebe Kebede',
    designation: 'Director at Ethiopian Space Science and Technology Institute',
    image:
    ...
    quote:
      "Tekletsadik's work on the SSGI NET application demonstrated his ability to create secure and efficient solutions for our specific needs.",
  },
  {
    name: 'Yohannes Libanos',
    designation: 'CEO at NexusLabs',
  ...
  },
  {
    ...
    quote:
      "I've had the pleasure of collaborating with Tekletsadik on various projects. His expertise in full-stack development is truly impressive.",
  },
  {
    name: 'Getnet Aseffa',
    designation: 'CTO at EagleLion System Technology',
    image:
    ...
    quote:
      "Tekletsadik's proficiency in Flutter and agile methodologies helped us deliver high-quality mobile applications efficiently.",
  },
  {
    name: 'Prof. Yalemzewd Negash',
    designation: 'Dean of Computing at Arbaminch University',
    image:
      'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80',
    quote:
      "As Tekletsadik's former professor, I can attest to his dedication and talent in computer software engineering.",
  },
  {
    name: 'Betelhem Dessie',
    designation: 'Project Lead at iCog Labs',
    image:
